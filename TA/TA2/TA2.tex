...
\noindent Práctica extra, no obligatoria y no cubierta en esta ayudantía.

\vspace{1em}

\noindent\textbf{Multicolinealidad perfecta.} Suponga que $x=(1,x_1,x_2)'$ y
$x_2=\alpha_1+\alpha_2 x_1$.
\begin{enumerate}
    \item Demuestre que $\E(xx')$ no es invertible. ¿Cuál es la causa de la no invertibilidad?
    \item Utilice la condición $\E(x(y-x'\beta))=0$ para encontrar $\beta$. ¿Cuáles son las
    consecuencias para el modelo de regresión o proyector lineal de la no invertibilidad de
    $\E(xx')$?
\end{enumerate}

\vspace{1em}

\noindent\textbf{Modelo con solo intercepto.} Considere el modelo con solamente un intercepto
$y=\beta_0+u$ donde $\beta_0$ es el proyector lineal. Demuestre que $\beta_0=\E(y)$.
