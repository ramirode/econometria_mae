   ...
   % --------------------------------------------------- Slide --
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \end{align*}
            \item [] Se usa: $\Pr(y=t)=\sum_u \Pr(x=u,y=t)$ (marginal a partir de la conjunta, con el orden de suma ya invertido en la tercera l\'inea); $\Pr(x=u,y=t)=\Pr(y=t|x=u)\Pr(x=u)$; y la definici\'on de $\E(y|x=u)$.
        \end{itemize}
    \end{frame}
          % --------------------------------------------------- Slide --       
   ...
   \begin{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            ...
            \caption{\footnotesize Regresi\'on y esperanza condicional del log de salarios en el nivel educativo. La muestra incluye hombres entre 30 y 65 a\~nos que trabajan, Casen 2024. \hyperlink{back2}{\beamergotobutton{back}}}
        \end{figure}
    \end{frame}
    % --------------------------------------------------- Slide --
    \begin{frame}
